...
Test case generator adopts a client-server architecture. The web-based UI interacts with the
server to provide an interactive interface, while the CLI and APIs enable automation
and integration.
